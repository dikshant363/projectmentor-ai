  ...
  return (
    <footer className="w-full bg-[#f5f5f7] text-[#333333] border-t border-[#e0e0e0] py-16 px-4 sm:px-8">
      <div className="max-w-[1024px] mx-auto">
        {/* Editorial Footnote */}
        <p className="text-[12px] text-[#7a7a7a] leading-relaxed pb-8 border-b border-[#e0e0e0]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 py-10 text-[14px]">
          <div>
            <h4 className="font-semibold text-[#1d1d1f] text-[14px] tracking-tight mb-3">
              Explore & Build
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-1 text-[#333333] leading-[2.41]">
              <li><span className="text-[#7a7a7a]">Computer Science (CSE)</span></li>
              <li><span className="text-[#7a7a7a]">Information Technology (IT)</span></li>
              <li><span className="text-[#7a7a7a]">AI & Data Science (AIDS)</span></li>
              <li><span className="text-[#7a7a7a]">Electronics (ECE) & IoT</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-[#333333] leading-[2.41]">
              <li><span className="text-[#7a7a7a]">Next.js 15 App Router</span></li>
              <li><span className="text-[#7a7a7a]">DESIGN.md Strict Tokens</span></li>
              <li><span className="text-[#7a7a7a]">Zero-Gradient Minimalist UI</span></li>
              <li><span className="text-[#7a7a7a]">Sub-10MB Clean Repository</span></li>
            </ul>
          </div>
        </div>

        {/* Legal & Attribution Bar */}
        <div className="pt-6 border-t border-[#e0e0e0] flex flex-col sm:flex-row items-center justify-between gap-4 text-[12px] text-[#7a7a7a]">
          <div>
